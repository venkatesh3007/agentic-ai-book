...
AI conversations get complex. You reference "that deploy from yesterday" or "the error we saw earlier." Contextual Threading adds message-level references and context reconstruction [@contextual-threading].
